...
Ứng dụng Next.js cho học sinh nghe video, đọc truyện và làm câu hỏi đọc hiểu. Thư viện được chia thành 12 tập theo tháng, mỗi tập có 28–31 ngày. Trang quản trị cho phép tạo/sửa/xóa truyện, gắn video YouTube, soạn câu hỏi và nhập hàng loạt bằng JSON.
...
2. Nếu tạo project Supabase mới, chạy [schema.sql](supabase/schema.sql) trong SQL Editor và nhập dữ liệu qua `/admin`.
